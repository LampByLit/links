              ...
              <div class="mobile-cards px-4">
                ${cards.map(card => `
                  <div class="mobile-card">
                    ...
                    <div class="mb-3">
                      <div class="text-xs text-gray-500 mb-1">Card Link:</div>
                      <a href="${baseUrl}/${card.slug}" target="_blank" class="text-blue-600 hover:text-blue-800 mobile-url font-mono">
                        ${baseUrl}/${card.slug}
                      </a>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <a href="${card.targetUrl}" target="_blank" class="text-blue-600 hover:text-blue-800 mobile-url">
                        ${card.targetUrl}
                      </a>
                    </div>
                    
                    <div class="text-xs text-gray-400">
                      Created: ${new Date(card.createdAt).toLocaleDateString()} ${new Date(card.createdAt).toLocaleTimeString()}
                    </div>
                  </div>
                `).join('')}
              </div>
